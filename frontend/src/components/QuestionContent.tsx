...
export default function QuestionContent({
  ...
  return (
    <div className="prose prose-slate max-w-none dark:prose-invert break-words overflow-hidden [&_pre]:overflow-auto [&_pre]:max-h-[400px] [&_pre]:bg-slate-900 [&_pre]:text-slate-100 [&_pre]:rounded-lg [&_pre]:p-4 [&_pre]:text-sm [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-inherit [&_.katex-display]:overflow-x-auto [&_table]:overflow-x-auto [&_code]:before:content-none [&_code]:after:content-none [&_code]:bg-slate-100 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-slate-800 [&_code]:font-mono [&_code]:text-[0.9em]">
